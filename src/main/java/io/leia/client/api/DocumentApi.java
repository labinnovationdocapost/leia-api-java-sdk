...
public class DocumentApi {
     ...
     */
    public okhttp3.Call getDocumentContentsAsync(String token, String documentId, Integer maxSize, Integer jpegCompression, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public File getDocumentsZip(String token, String documentId, String filename, String extension, String mimeType, String originalId, List<String> tags, OffsetDateTime createdAfter, OffsetDateTime createdBefore) throws ApiException {
        ApiResponse<File> localVarResp = getDocumentsZipWithHttpInfo(token, documentId, filename, extension, mimeType, originalId, tags, createdAfter, createdBefore);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> getDocumentsZipWithHttpInfo(String token, String documentId, String filename, String extension, String mimeType, String originalId, List<String> tags, OffsetDateTime createdAfter, OffsetDateTime createdBefore) throws ApiException {
     ...
     */
    public okhttp3.Call getDocumentsZipAsync(String token, String documentId, String filename, String extension, String mimeType, String originalId, List<String> tags, OffsetDateTime createdAfter, OffsetDateTime createdBefore, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call transformDocumentAsyncCall(String token, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String pageRange, String callbackUrl, Object transformParams, Boolean blockProcessing, TransformBody transformBody, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call transformDocumentAsyncValidateBeforeCall(String token, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String pageRange, String callbackUrl, Object transformParams, Boolean blockProcessing, TransformBody transformBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = transformDocumentAsyncCall(token, documentIds, outputType, inputTag, outputTag, executeAfterId, pageRange, callbackUrl, transformParams, blockProcessing, transformBody, _callback);
        return localVarCall;
     ...
     */
    public Job transformDocumentAsync(String token, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String pageRange, String callbackUrl, Object transformParams, Boolean blockProcessing, TransformBody transformBody) throws ApiException {
        ApiResponse<Job> localVarResp = transformDocumentAsyncWithHttpInfo(token, documentIds, outputType, inputTag, outputTag, executeAfterId, pageRange, callbackUrl, transformParams, blockProcessing, transformBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Job> transformDocumentAsyncWithHttpInfo(String token, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String pageRange, String callbackUrl, Object transformParams, Boolean blockProcessing, TransformBody transformBody) throws ApiException {
        okhttp3.Call localVarCall = transformDocumentAsyncValidateBeforeCall(token, documentIds, outputType, inputTag, outputTag, executeAfterId, pageRange, callbackUrl, transformParams, blockProcessing, transformBody, null);
     ...
     */
    public okhttp3.Call transformDocumentAsyncAsync(String token, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String pageRange, String callbackUrl, Object transformParams, Boolean blockProcessing, TransformBody transformBody, final ApiCallback<Job> _callback) throws ApiException {

        okhttp3.Call localVarCall = transformDocumentAsyncValidateBeforeCall(token, documentIds, outputType, inputTag, outputTag, executeAfterId, pageRange, callbackUrl, transformParams, blockProcessing, transformBody, _callback);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
