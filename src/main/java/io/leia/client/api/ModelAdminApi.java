...
public class ModelAdminApi {
    ...
    private okhttp3.Call adminCreateModelValidateBeforeCall(String token, String applicationId, String name, byte[] body, String description, Integer ttl, List<String> allowedApplicationIds, Boolean allowAllApplications, List<String> tags, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = adminCreateModelCall(token, applicationId, name, body, description, ttl, allowedApplicationIds, allowAllApplications, tags, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call adminEditModelCall(String token, String applicationId, String modelId, String name, String description, List<String> allowedApplicationIds, Boolean allowAllApplications, Integer ttl, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminEditModelValidateBeforeCall(String token, String applicationId, String modelId, String name, String description, List<String> allowedApplicationIds, Boolean allowAllApplications, Integer ttl, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = adminEditModelCall(token, applicationId, modelId, name, description, allowedApplicationIds, allowAllApplications, ttl, _callback);
        return localVarCall;
     ...
     */
    public Model adminEditModel(String token, String applicationId, String modelId, String name, String description, List<String> allowedApplicationIds, Boolean allowAllApplications, Integer ttl) throws ApiException {
        ApiResponse<Model> localVarResp = adminEditModelWithHttpInfo(token, applicationId, modelId, name, description, allowedApplicationIds, allowAllApplications, ttl);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Model> adminEditModelWithHttpInfo(String token, String applicationId, String modelId, String name, String description, List<String> allowedApplicationIds, Boolean allowAllApplications, Integer ttl) throws ApiException {
        okhttp3.Call localVarCall = adminEditModelValidateBeforeCall(token, applicationId, modelId, name, description, allowedApplicationIds, allowAllApplications, ttl, null);
        Type localVarReturnType = new TypeToken<Model>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call adminEditModelAsync(String token, String applicationId, String modelId, String name, String description, List<String> allowedApplicationIds, Boolean allowAllApplications, Integer ttl, final ApiCallback<Model> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminEditModelValidateBeforeCall(token, applicationId, modelId, name, description, allowedApplicationIds, allowAllApplications, ttl, _callback);
        Type localVarReturnType = new TypeToken<Model>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call adminGetModelsValidateBeforeCall(String token, String modelId, String applicationId, ModelTypes modelType, String name, String description, List<ModelInputTypes> inputTypes, List<String> tags, OffsetDateTime createdAfter, OffsetDateTime createdBefore, Boolean onlyMine, String sort, Integer offset, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = adminGetModelsCall(token, modelId, applicationId, modelType, name, description, inputTypes, tags, createdAfter, createdBefore, onlyMine, sort, offset, limit, _callback);
        return localVarCall;
    ...
    public List<Model> adminGetModels(String token, String modelId, String applicationId, ModelTypes modelType, String name, String description, List<ModelInputTypes> inputTypes, List<String> tags, OffsetDateTime createdAfter, OffsetDateTime createdBefore, Boolean onlyMine, String sort, Integer offset, Integer limit) throws ApiException {
        ApiResponse<List<Model>> localVarResp = adminGetModelsWithHttpInfo(token, modelId, applicationId, modelType, name, description, inputTypes, tags, createdAfter, createdBefore, onlyMine, sort, offset, limit);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<List<Model>> adminGetModelsWithHttpInfo(String token, String modelId, String applicationId, ModelTypes modelType, String name, String description, List<ModelInputTypes> inputTypes, List<String> tags, OffsetDateTime createdAfter, OffsetDateTime createdBefore, Boolean onlyMine, String sort, Integer offset, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = adminGetModelsValidateBeforeCall(token, modelId, applicationId, modelType, name, description, inputTypes, tags, createdAfter, createdBefore, onlyMine, sort, offset, limit, null);
    ...
    public okhttp3.Call adminGetModelsAsync(String token, String modelId, String applicationId, ModelTypes modelType, String name, String description, List<ModelInputTypes> inputTypes, List<String> tags, OffsetDateTime createdAfter, OffsetDateTime createdBefore, Boolean onlyMine, String sort, Integer offset, Integer limit, final ApiCallback<List<Model>> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = adminGetModelsValidateBeforeCall(token, modelId, applicationId, modelType, name, description, inputTypes, tags, createdAfter, createdBefore, onlyMine, sort, offset, limit, _callback);
        Type localVarReturnType = new TypeToken<List<Model>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
