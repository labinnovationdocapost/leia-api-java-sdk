...
public class DocumentAdminApi {
     ...
     */
    public okhttp3.Call adminTransformDocumentAsyncCall(String token, String applicationId, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String callbackUrl, Object transformParams, TransformBody transformBody, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminTransformDocumentAsyncValidateBeforeCall(String token, String applicationId, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String callbackUrl, Object transformParams, TransformBody transformBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = adminTransformDocumentAsyncCall(token, applicationId, documentIds, outputType, inputTag, outputTag, executeAfterId, callbackUrl, transformParams, transformBody, _callback);
        return localVarCall;
     ...
     */
    public Job adminTransformDocumentAsync(String token, String applicationId, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String callbackUrl, Object transformParams, TransformBody transformBody) throws ApiException {
        ApiResponse<Job> localVarResp = adminTransformDocumentAsyncWithHttpInfo(token, applicationId, documentIds, outputType, inputTag, outputTag, executeAfterId, callbackUrl, transformParams, transformBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Job> adminTransformDocumentAsyncWithHttpInfo(String token, String applicationId, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String callbackUrl, Object transformParams, TransformBody transformBody) throws ApiException {
        okhttp3.Call localVarCall = adminTransformDocumentAsyncValidateBeforeCall(token, applicationId, documentIds, outputType, inputTag, outputTag, executeAfterId, callbackUrl, transformParams, transformBody, null);
     ...
     */
    public okhttp3.Call adminTransformDocumentAsyncAsync(String token, String applicationId, List<String> documentIds, TransformTypes outputType, String inputTag, String outputTag, String executeAfterId, String callbackUrl, Object transformParams, TransformBody transformBody, final ApiCallback<Job> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminTransformDocumentAsyncValidateBeforeCall(token, applicationId, documentIds, outputType, inputTag, outputTag, executeAfterId, callbackUrl, transformParams, transformBody, _callback);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
