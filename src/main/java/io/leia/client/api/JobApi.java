...
public class JobApi {
    ...
    /**
     * Build call for createConditionalJob
     * @param token The login token obtained via GET /login/{api_key} (required)
     ...
     */
    public okhttp3.Call createConditionalJobCall(String token, String executeAfterId, String callbackUrl, Boolean blockProcessing, ConditionalBody conditionalBody, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createConditionalJobValidateBeforeCall(String token, String executeAfterId, String callbackUrl, Boolean blockProcessing, ConditionalBody conditionalBody, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'token' is set
        if (token == null) {
            throw new ApiException("Missing the required parameter 'token' when calling createConditionalJob(Async)");
        }
        
        // verify the required parameter 'executeAfterId' is set
        if (executeAfterId == null) {
            throw new ApiException("Missing the required parameter 'executeAfterId' when calling createConditionalJob(Async)");
        }
        

        okhttp3.Call localVarCall = createConditionalJobCall(token, executeAfterId, callbackUrl, blockProcessing, conditionalBody, _callback);
        return localVarCall;
     ...
     */
    public Job createConditionalJob(String token, String executeAfterId, String callbackUrl, Boolean blockProcessing, ConditionalBody conditionalBody) throws ApiException {
        ApiResponse<Job> localVarResp = createConditionalJobWithHttpInfo(token, executeAfterId, callbackUrl, blockProcessing, conditionalBody);
     ...
     */
    public ApiResponse<Job> createConditionalJobWithHttpInfo(String token, String executeAfterId, String callbackUrl, Boolean blockProcessing, ConditionalBody conditionalBody) throws ApiException {
        okhttp3.Call localVarCall = createConditionalJobValidateBeforeCall(token, executeAfterId, callbackUrl, blockProcessing, conditionalBody, null);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Asynchronously and conditionaly applies model(s) on documents (asynchronously)
     * Asynchronously runs one or more list of jobs on accessible documents and returns a Job.&lt;br /&gt; The list of jobs to run and the documents on which they should be run will be chosen depending on the rules parameter that is set in the body of the request and the result of the execute_after_id job.&lt;br /&gt; Rules should be a map[string,object] where the key is a user chosen id and the value is a list of objects containing the same parameters as normal calls to /model/{model_id}/apply{document_ids} or /document/{document_ids}/transform/{output_type} and a conditions field.&lt;br /&gt; If all the field/values in the conditions of a rule are contained as is in the result of the execute_after_id job, then the list of jobs will be executed in order with the given parameters, each job depending on the previous one in the list, else it won&#39;t be executed at all&lt;br /&gt; Syntax for conditions is as follows:   * \&quot;field_name\&quot; : value In which case the field field_name must be equal to the value for the job to be executed. value can be any valid json type (int, float, string...)   * \&quot;field_name\&quot;: {\&quot;operator\&quot; : value} Where operator is a [Mongo like comparison operator](https://docs.mongodb.com/manual/reference/operator/query-comparison/). In this case the comparison between field field_name&#39;s value must be true for the job to be executed. value can be any valid json type (int, float, string...)   * \&quot;field_name\&quot;: [{\&quot;operator_1\&quot; : value_1}...{\&quot;operator_n\&quot; : value_n}] Where operator_i is a [Mongo like comparison operator](https://docs.mongodb.com/manual/reference/operator/query-comparison/). In this case the comparison between field field_name&#39;s value must be true for all items in the list for the job to be executed. value_i can be any valid json type (int, float, string...). {\&quot;$eq\&quot; : value_i} can be abbreviated as value_i in the list.  You can keep the document_ids field of any job empty apart for the first job of a rule. If it is, the job will use the results of previous job&#39;s as an input if no tag is set, or the document_ids of the execute_after_id job + tag if tag is set.&lt;br /&gt; If the conditions are not mutually exclusive, 2 or more models may be executed.&lt;br /&gt; The result will be sent back as a map of results where the key is the rule id, and containing one entry for list of jobs that was executed. This entry will contain all the results of the executed jobs, in execution order&lt;br /&gt; This is mostly but not necessarily meant to be used after a classifier model, so that an execution path can be chosen automatically depending on the result of the classification. 
     * @param token The login token obtained via GET /login/{api_key} (required)
     * @param executeAfterId The id of a job that must be in PROCESSED status before this one can be started (used to chain jobs even before the first ones are terminated). If the referenced job becomes FAILED or is CANCELED, this one will fail (required)
     * @param callbackUrl Callback URL that should be called when the job becomes PROCESSED/FAILED/CANCELED. This URL will be called with a HTTP POST method, and the Job object as the payload. Callback server must answer with either a 200 or 204 HTTP response, to acknowledge the callback. Any other response code will be considered as a failure to call the callback. (optional)
     ...
     */
    public okhttp3.Call createConditionalJobAsync(String token, String executeAfterId, String callbackUrl, Boolean blockProcessing, ConditionalBody conditionalBody, final ApiCallback<Job> _callback) throws ApiException {

        okhttp3.Call localVarCall = createConditionalJobValidateBeforeCall(token, executeAfterId, callbackUrl, blockProcessing, conditionalBody, _callback);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
     ...
     */
    public okhttp3.Call startJobCall(String token, String jobId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/job/{job_id}/start"
            .replaceAll("\\{" + "job_id" + "\\}", localVarApiClient.escapeString(jobId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call startJobValidateBeforeCall(String token, String jobId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'token' is set
        if (token == null) {
            throw new ApiException("Missing the required parameter 'token' when calling startJob(Async)");
        }
        ...
        okhttp3.Call localVarCall = startJobCall(token, jobId, _callback);
        return localVarCall;
     ...
     */
    public Job startJob(String token, String jobId) throws ApiException {
        ApiResponse<Job> localVarResp = startJobWithHttpInfo(token, jobId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Job> startJobWithHttpInfo(String token, String jobId) throws ApiException {
        okhttp3.Call localVarCall = startJobValidateBeforeCall(token, jobId, null);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call startJobAsync(String token, String jobId, final ApiCallback<Job> _callback) throws ApiException {

        okhttp3.Call localVarCall = startJobValidateBeforeCall(token, jobId, _callback);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
