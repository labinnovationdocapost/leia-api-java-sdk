...
public class ApplicationAdminApi {
    ...
    /**
     * Build call for adminDeleteAlwaysOnSchedule
     * @param token The login token obtained via GET /login/{api_key} (required)
     * @param applicationId The id of the application (required)
     * @param alwaysOnScheduleId The id of the schedule to delete (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> The schedule was successfully deleted </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Not logged in </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Application or schedule not found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call adminDeleteAlwaysOnScheduleCall(String token, String applicationId, String alwaysOnScheduleId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/admin/application/{application_id}/always_on_schedules/{always_on_schedule_id}"
            .replaceAll("\\{" + "application_id" + "\\}", localVarApiClient.escapeString(applicationId.toString()))
            .replaceAll("\\{" + "always_on_schedule_id" + "\\}", localVarApiClient.escapeString(alwaysOnScheduleId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminDeleteAlwaysOnScheduleValidateBeforeCall(String token, String applicationId, String alwaysOnScheduleId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'token' is set
        if (token == null) {
            throw new ApiException("Missing the required parameter 'token' when calling adminDeleteAlwaysOnSchedule(Async)");
        }
        
        // verify the required parameter 'applicationId' is set
        if (applicationId == null) {
            throw new ApiException("Missing the required parameter 'applicationId' when calling adminDeleteAlwaysOnSchedule(Async)");
        }
        
        // verify the required parameter 'alwaysOnScheduleId' is set
        if (alwaysOnScheduleId == null) {
            throw new ApiException("Missing the required parameter 'alwaysOnScheduleId' when calling adminDeleteAlwaysOnSchedule(Async)");
        }
        

        okhttp3.Call localVarCall = adminDeleteAlwaysOnScheduleCall(token, applicationId, alwaysOnScheduleId, _callback);
        return localVarCall;
     ...
     */
    public void adminDeleteAlwaysOnSchedule(String token, String applicationId, String alwaysOnScheduleId) throws ApiException {
        adminDeleteAlwaysOnScheduleWithHttpInfo(token, applicationId, alwaysOnScheduleId);
    }
     ...
     */
    public ApiResponse<Void> adminDeleteAlwaysOnScheduleWithHttpInfo(String token, String applicationId, String alwaysOnScheduleId) throws ApiException {
        okhttp3.Call localVarCall = adminDeleteAlwaysOnScheduleValidateBeforeCall(token, applicationId, alwaysOnScheduleId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Removes a schedule from an application (asynchronously)
     * Removes a schedule from an application
     * @param token The login token obtained via GET /login/{api_key} (required)
     * @param applicationId The id of the application (required)
     * @param alwaysOnScheduleId The id of the schedule to delete (required)
     ...
     */
    public okhttp3.Call adminDeleteAlwaysOnScheduleAsync(String token, String applicationId, String alwaysOnScheduleId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminDeleteAlwaysOnScheduleValidateBeforeCall(token, applicationId, alwaysOnScheduleId, _callback);
     ...
     * @param applicationName The new name of the application (optional)
     * @param email The new email of the application (optional)
     * @param firstName The new first name of the application (optional)
     * @param lastName The new last name of the application (optional)
     ...
     * @param dedicatedWorkersMaxModels When using dedicated workers, maximum number of models loaded at the same time (optional)
     ...
     * @param alwaysOnNumber Adds a schedule for always on workers. Will start number always on workers when start time happens and stop them at stop time. (Check always_on_* parameters to set other parameters) (optional)
     * @param alwaysOnStartDays Adds a schedule for always on workers. Set the day(s) of the week at which the worker will start (1 is Monday, 7 is Sunday, comma separated). Stop day will be the same day. (Check always_on_* parameters to set other parameters) (optional)
     * @param alwaysOnStartHour Adds a schedule for always on workers. Set the hour at which the worker will start (between 0 and 23). (Check always_on_* parameters to set other parameters) (optional)
     * @param alwaysOnStopHour Adds a schedule for always on workers. Set the hour at which the worker will stop (between 0 and 23, stop must happen after start). (Check always_on_* parameters to set other parameters) (optional)
     * @param alwaysOnStartMinute Adds a schedule for always on workers. Set the minute at which the worker will start (between 0 and 59). (Check always_on_* parameters to set other parameters) (optional)
     * @param alwaysOnStopMinute Adds a schedule for always on workers. Set the minute at which the worker will stop (between 0 and 59, stop must happen after start). (Check always_on_* parameters to set other parameters) (optional)
     * @param alwaysOnWorkersModelIds When using dedicated workers with always on schedule, the models that should be loaded on start of the worker (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call adminEditApplicationCall(String token, String applicationId, String applicationName, String email, String firstName, String lastName, String defaultJobCallbackUrl, Boolean dedicatedWorkers, Integer dedicatedWorkersTtl, Integer dedicatedWorkersMaxModels, Boolean reduceCallbackPayloads, Integer alwaysOnNumber, List<Integer> alwaysOnStartDays, Integer alwaysOnStartHour, Integer alwaysOnStopHour, Integer alwaysOnStartMinute, Integer alwaysOnStopMinute, List<String> alwaysOnWorkersModelIds, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (dedicatedWorkersMaxModels != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("dedicated_workers_max_models", dedicatedWorkersMaxModels));
        }
        ...
        if (alwaysOnNumber != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("always_on_number", alwaysOnNumber));
        }

        if (alwaysOnStartDays != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "always_on_start_days", alwaysOnStartDays));
        }

        if (alwaysOnStartHour != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("always_on_start_hour", alwaysOnStartHour));
        }

        if (alwaysOnStopHour != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("always_on_stop_hour", alwaysOnStopHour));
        }

        if (alwaysOnStartMinute != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("always_on_start_minute", alwaysOnStartMinute));
        }

        if (alwaysOnStopMinute != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("always_on_stop_minute", alwaysOnStopMinute));
        }

        if (alwaysOnWorkersModelIds != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "always_on_workers_model_ids", alwaysOnWorkersModelIds));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminEditApplicationValidateBeforeCall(String token, String applicationId, String applicationName, String email, String firstName, String lastName, String defaultJobCallbackUrl, Boolean dedicatedWorkers, Integer dedicatedWorkersTtl, Integer dedicatedWorkersMaxModels, Boolean reduceCallbackPayloads, Integer alwaysOnNumber, List<Integer> alwaysOnStartDays, Integer alwaysOnStartHour, Integer alwaysOnStopHour, Integer alwaysOnStartMinute, Integer alwaysOnStopMinute, List<String> alwaysOnWorkersModelIds, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Application adminEditApplication(String token, String applicationId, String applicationName, String email, String firstName, String lastName, String defaultJobCallbackUrl, Boolean dedicatedWorkers, Integer dedicatedWorkersTtl, Integer dedicatedWorkersMaxModels, Boolean reduceCallbackPayloads, Integer alwaysOnNumber, List<Integer> alwaysOnStartDays, Integer alwaysOnStartHour, Integer alwaysOnStopHour, Integer alwaysOnStartMinute, Integer alwaysOnStopMinute, List<String> alwaysOnWorkersModelIds) throws ApiException {
        ApiResponse<Application> localVarResp = adminEditApplicationWithHttpInfo(token, applicationId, applicationName, email, firstName, lastName, defaultJobCallbackUrl, dedicatedWorkers, dedicatedWorkersTtl, dedicatedWorkersMaxModels, reduceCallbackPayloads, alwaysOnNumber, alwaysOnStartDays, alwaysOnStartHour, alwaysOnStopHour, alwaysOnStartMinute, alwaysOnStopMinute, alwaysOnWorkersModelIds);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Application> adminEditApplicationWithHttpInfo(String token, String applicationId, String applicationName, String email, String firstName, String lastName, String defaultJobCallbackUrl, Boolean dedicatedWorkers, Integer dedicatedWorkersTtl, Integer dedicatedWorkersMaxModels, Boolean reduceCallbackPayloads, Integer alwaysOnNumber, List<Integer> alwaysOnStartDays, Integer alwaysOnStartHour, Integer alwaysOnStopHour, Integer alwaysOnStartMinute, Integer alwaysOnStopMinute, List<String> alwaysOnWorkersModelIds) throws ApiException {
        okhttp3.Call localVarCall = adminEditApplicationValidateBeforeCall(token, applicationId, applicationName, email, firstName, lastName, defaultJobCallbackUrl, dedicatedWorkers, dedicatedWorkersTtl, dedicatedWorkersMaxModels, reduceCallbackPayloads, alwaysOnNumber, alwaysOnStartDays, alwaysOnStartHour, alwaysOnStopHour, alwaysOnStartMinute, alwaysOnStopMinute, alwaysOnWorkersModelIds, null);
        Type localVarReturnType = new TypeToken<Application>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call adminEditApplicationAsync(String token, String applicationId, String applicationName, String email, String firstName, String lastName, String defaultJobCallbackUrl, Boolean dedicatedWorkers, Integer dedicatedWorkersTtl, Integer dedicatedWorkersMaxModels, Boolean reduceCallbackPayloads, Integer alwaysOnNumber, List<Integer> alwaysOnStartDays, Integer alwaysOnStartHour, Integer alwaysOnStopHour, Integer alwaysOnStartMinute, Integer alwaysOnStopMinute, List<String> alwaysOnWorkersModelIds, final ApiCallback<Application> _callback) throws ApiException {
